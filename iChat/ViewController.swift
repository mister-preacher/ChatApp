...
class ViewController: MessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        let item = UIBarButtonItem(title: "0", style: .plain, target: self, action: #selector(didTapMembersButton))
    ...
    func showTypingLabel() {
        UIView.animate(withDuration: 0.3) { self.typingLabel.isHidden = false }
    }
    
    func hideTypingLabel() {
        UIView.animate(withDuration: 0.3) { self.typingLabel.isHidden = true }
    }
